      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="relative">
          ...
          >
            ...
            {/* Navigation Arrows */}
            <CarouselPrevious className="absolute -left-12 top-1/2 -translate-y-1/2 bg-white border-gray-300 hover:bg-gray-50 hover:border-gray-400 text-gray-600" />
            <CarouselNext className="absolute -right-12 top-1/2 -translate-y-1/2 bg-white border-gray-300 hover:bg-gray-50 hover:border-gray-400 text-gray-600" />
          </Carousel>
        </div>
      </div>
    </section>
